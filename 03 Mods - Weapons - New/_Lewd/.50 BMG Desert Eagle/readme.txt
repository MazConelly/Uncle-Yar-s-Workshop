...
This can be used on its own to be used with other .50 BMG weapons without the main mod, though then you'll only find them in traders.

You still need from the original mod's directory:
gamedata\textures\wpn\wpn_50bmg_deagle\

All .dds and .thm files sharing these names fully or partly:
lewd_grip_mag
50bmg_drum
