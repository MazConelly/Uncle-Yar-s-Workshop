...
Except the Mags Redux and jam idles patches, you can still use the patches in the original mod.

"Hisalute's Weapon Packs - Fixes and Tweaks" includes a similar patch with the same content. Use one or the other, but do not use both.
...
This patch is only intended for the original SWP, as it is. Do not use with the main files of this module, or "Hisalute's Weapon Packs - Fixes and Tweaks", which already modularizes some guns as optional, including the M1A1 and M1928.
